<template>
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			<el-col :span="16" style="font-size:26px;">
				<img src="../assets/logo4.png" class="logo"> <span>AD<i style="color:#20a0ff">MIN</i></span>
			</el-col>
			<el-col :span="4"><span>{{ userName | wrap('hi ','你好！')}}</span> Login-Time: {{ time | formatDate('yyyy-MM-dd')}}</el-col>
			<el-col :span="4">
		...
		<el-col :span="24" class="panel-center">
			...
			<aside style="width:230px;">
				...
				<el-menu style="border-top: 1px solid #475669;" :default-active=$route.path class="el-menu-vertical-demo" @open="handleopen"
...
<script>
  ...
  export default {
    data() {
      return {
			time: new Date(), //测试时间过滤器
			userName: 'bear', //测试自定义过滤器
			currentPlay: '', //测试双向过滤器
